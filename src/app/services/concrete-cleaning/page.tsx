...
export default function ConcreteCleaning() {
  // Service schema for concrete cleaning
  const serviceSchema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Concrete Cleaning Los Angeles",
    "provider": {
      "@type": "LocalBusiness",
    ...
    "description": "Professional concrete cleaning services in Los Angeles. We clean driveways, sidewalks, patios, and all concrete surfaces.",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-16">
            ...
            <p className="text-lg text-gray-600">
              Our concrete cleaning service removes tough stains, oil, grease, and grime from all types of concrete surfaces. We use professional-grade equipment and eco-friendly cleaning solutions to restore your concrete's appearance while protecting its integrity.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            <div className="bg-white rounded-lg shadow-md p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-4">Residential Concrete Cleaning</h3>
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-4">Commercial Concrete Cleaning</h3>
              <ul className="list-disc pl-5 text-gray-600 space-y-2">
          ...
          <div className="bg-gray-50 rounded-lg p-8 mb-16">
            <h3 className="text-2xl font-bold text-gray-900 mb-6">Our Concrete Cleaning Process</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div>
                <h4 className="text-lg font-semibold text-gray-900 mb-2">Surface Preparation</h4>
                <p className="text-gray-600">Thorough sweeping and debris removal before cleaning begins.</p>
              </div>
              <div>
