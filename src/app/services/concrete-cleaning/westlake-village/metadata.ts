...
export const metadata = {
  title: 'Concrete Cleaning in Westlake Village | Professional Services',
  ...
  keywords: 'concrete cleaning, westlake village concrete cleaning, driveway cleaning, patio restoration, pool deck cleaning, walkway maintenance, westlake village property maintenance',
  alternates: {
