...
export default function ConcreteCleaningBeverlyHills() {
  // Service schema with city-specific information
  const serviceSchema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Concrete Cleaning in Beverly Hills",
    "provider": {
      "@type": "LocalBusiness",
    ...
    "description": "Professional concrete cleaning and restoration services in Beverly Hills, Los Angeles County.",
  ...
  return (
    <>
      ...
      <Hero
        title="Concrete Cleaning in Beverly Hills"
        subtitle="Professional concrete cleaning services for Beverly Hills properties"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Expert Concrete Cleaning in Beverly Hills
            </h2>
            <p className="text-lg text-gray-600">
              We provide professional concrete cleaning services throughout Beverly Hills. 
