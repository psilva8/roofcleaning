...
export default function CommercialPressureWashingArcadia() {
  ...
  const serviceSchema = {
    ...
    "description": "Professional commercial pressure washing services for businesses in Arcadia, Los Angeles County.",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Expert Commercial Pressure Washing in Arcadia
            </h2>
            <p className="text-lg text-gray-600">
              We provide professional commercial pressure washing services throughout Arcadia. 
