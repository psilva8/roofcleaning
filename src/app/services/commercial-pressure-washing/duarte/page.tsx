...
export default function CommercialPressureWashingDuarte() {
  // Service schema with city-specific information
  const serviceSchema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Commercial Pressure Washing in Duarte",
    "provider": {
      "@type": "LocalBusiness",
    ...
    "description": "Professional commercial pressure washing services for businesses in Duarte, Los Angeles County.",
  ...
  return (
    <>
      ...
      <Hero
        title="Commercial Pressure Washing in Duarte"
        subtitle="Professional commercial pressure washing services for Duarte properties"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Expert Commercial Pressure Washing in Duarte
            </h2>
            <p className="text-lg text-gray-600">
              We provide professional commercial pressure washing services throughout Duarte. 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            <div className="bg-white rounded-lg shadow-md p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-4">Why Choose Us in Duarte</h3>
              <ul className="list-disc pl-5 text-gray-600 space-y-2">
                <li>Local Duarte service provider</li>
