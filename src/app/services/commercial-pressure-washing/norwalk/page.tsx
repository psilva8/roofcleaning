...
export default function CommercialPressureWashingNorwalk() {
  // Service schema with city-specific information
  const serviceSchema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Commercial Pressure Washing in Norwalk",
    "provider": {
      "@type": "LocalBusiness",
    ...
    "description": "Professional commercial pressure washing services for businesses in Norwalk, Los Angeles County.",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Expert Commercial Pressure Washing in Norwalk
            </h2>
            <p className="text-lg text-gray-600">
              We provide professional commercial pressure washing services throughout Norwalk. 
