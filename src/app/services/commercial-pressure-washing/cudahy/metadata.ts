...
export const metadata = {
  ...
  keywords: 'commercial pressure washing, cudahy commercial pressure washing, building exterior washing, parking lot and garage cleaning, sidewalk and walkway cleaning, dumpster pad cleaning, cudahy property maintenance',
  alternates: {
