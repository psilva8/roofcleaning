...
export default function DeckAndPatioCleaningLaVerne() {
  // Service schema with city-specific information
  const serviceSchema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Deck and Patio Cleaning in La Verne",
    "provider": {
      "@type": "LocalBusiness",
    ...
    "description": "Expert deck and patio cleaning services in La Verne, Los Angeles County.",
  ...
  return (
    <>
      ...
      <Hero
        title="Deck and Patio Cleaning in La Verne"
        subtitle="Professional deck and patio cleaning services for La Verne properties"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Expert Deck and Patio Cleaning in La Verne
            </h2>
            <p className="text-lg text-gray-600">
              We provide professional deck and patio cleaning services throughout La Verne. 
