...
export default function DeckAndPatioCleaningSouthGate() {
  ...
  const serviceSchema = {
    ...
    "description": "Expert deck and patio cleaning services in South Gate, Los Angeles County.",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Expert Deck and Patio Cleaning in South Gate
            </h2>
            <p className="text-lg text-gray-600">
              We provide professional deck and patio cleaning services throughout South Gate. 
