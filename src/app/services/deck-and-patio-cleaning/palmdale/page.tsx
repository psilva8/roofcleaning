...
export default function DeckAndPatioCleaningPalmdale() {
  // Service schema with city-specific information
  const serviceSchema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Deck and Patio Cleaning in Palmdale",
    "provider": {
      "@type": "LocalBusiness",
    ...
    "description": "Expert deck and patio cleaning services in Palmdale, Los Angeles County.",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Expert Deck and Patio Cleaning in Palmdale
            </h2>
            <p className="text-lg text-gray-600">
              We provide professional deck and patio cleaning services throughout Palmdale. 
