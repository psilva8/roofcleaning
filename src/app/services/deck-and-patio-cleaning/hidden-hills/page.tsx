...
export default function DeckAndPatioCleaningHiddenHills() {
  // Service schema with city-specific information
  const serviceSchema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Deck and Patio Cleaning in Hidden Hills",
    "provider": {
      "@type": "LocalBusiness",
    ...
    "description": "Expert deck and patio cleaning services in Hidden Hills, Los Angeles County.",
  ...
  return (
    <>
      ...
      <Hero
        title="Deck and Patio Cleaning in Hidden Hills"
        subtitle="Professional deck and patio cleaning services for Hidden Hills properties"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Expert Deck and Patio Cleaning in Hidden Hills
            </h2>
            <p className="text-lg text-gray-600">
              We provide professional deck and patio cleaning services throughout Hidden Hills. 
