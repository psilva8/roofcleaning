...
export default function DeckAndPatioCleaningLaHabraHeights() {
  // Service schema with city-specific information
  const serviceSchema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Deck and Patio Cleaning in La Habra Heights",
    "provider": {
      "@type": "LocalBusiness",
    ...
    "description": "Expert deck and patio cleaning services in La Habra Heights, Los Angeles County.",
  ...
  return (
    <>
      ...
      <Hero
        title="Deck and Patio Cleaning in La Habra Heights"
        subtitle="Professional deck and patio cleaning services for La Habra Heights properties"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Expert Deck and Patio Cleaning in La Habra Heights
            </h2>
            <p className="text-lg text-gray-600">
              We provide professional deck and patio cleaning services throughout La Habra Heights. 
