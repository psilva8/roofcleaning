...
export default function RoofCleaningPasadena() {
  ...
  const serviceSchema = {
    ...
    "description": "Safe and effective roof cleaning services in Pasadena, Los Angeles County.",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Expert Roof Cleaning in Pasadena
            </h2>
            <p className="text-lg text-gray-600">
              We provide professional roof cleaning services throughout Pasadena. 
