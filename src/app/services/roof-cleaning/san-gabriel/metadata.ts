...
export const metadata = {
  title: 'Roof Cleaning in San Gabriel | Professional Services',
  ...
  keywords: 'roof cleaning, san gabriel roof cleaning, moss treatment, gutter system cleaning, preventive treatments, shingle cleaning, san gabriel property maintenance',
  alternates: {
