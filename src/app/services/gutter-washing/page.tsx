...
export default function GutterWashing() {
  // Service schema for gutter washing
  const serviceSchema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Gutter Washing Los Angeles",
    "provider": {
      "@type": "LocalBusiness",
    ...
    "description": "Professional gutter washing services in Los Angeles. We clean and maintain gutters to prevent water damage and protect your home.",
  ...
  return (
    <>
      ...
      <Hero
        title="Professional Gutter Washing"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Expert Gutter Washing Services
            </h2>
            <p className="text-lg text-gray-600">
              Keep your gutters functioning properly with our professional washing services. We remove debris, check for damage, and ensure proper water flow to protect your home from water damage and foundation issues.
            </p>
          </div>
          ...
          <div className="bg-primary/5 rounded-lg p-8 mb-16">
            <h3 className="text-2xl font-bold text-gray-900 mb-4">Signs You Need Gutter Washing</h3>
