...
export default function ResidentialHouseWashingArcadia() {
  const serviceSchema = {
    ...
    "@type": "Service",
    "name": "Residential House Washing in Arcadia",
    "provider": {
      "@type": "LocalBusiness",
  ...
  return (
    <>
      ...
      <Hero
        title="Residential House Washing in Arcadia"
        subtitle="Professional residential house washing services for Arcadia properties"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Residential House Washing in Arcadia
            </h2>
