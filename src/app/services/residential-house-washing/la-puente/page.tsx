...
export default function ResidentialHouseWashingLaPuente() {
  // Service schema with city-specific information
  const serviceSchema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Residential House Washing in La Puente",
    "provider": {
      "@type": "LocalBusiness",
    ...
    "description": "Expert house washing services for homes in La Puente, Los Angeles County.",
  ...
  return (
    <>
      ...
      <Hero
        title="Residential House Washing in La Puente"
        subtitle="Professional residential house washing services for La Puente properties"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Expert Residential House Washing in La Puente
            </h2>
            <p className="text-lg text-gray-600">
              We provide professional residential house washing services throughout La Puente. 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            <div className="bg-white rounded-lg shadow-md p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-4">Why Choose Us in La Puente</h3>
              <ul className="list-disc pl-5 text-gray-600 space-y-2">
                <li>Local La Puente service provider</li>
