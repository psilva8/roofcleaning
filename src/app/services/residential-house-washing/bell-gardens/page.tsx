...
export default function ResidentialHouseWashingBellGardens() {
  // Service schema with city-specific information
  const serviceSchema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Residential House Washing in Bell Gardens",
    "provider": {
      "@type": "LocalBusiness",
    ...
    "description": "Expert house washing services for homes in Bell Gardens, Los Angeles County.",
  ...
  return (
    <>
      ...
      <Hero
        title="Residential House Washing in Bell Gardens"
        subtitle="Professional residential house washing services for Bell Gardens properties"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Expert Residential House Washing in Bell Gardens
            </h2>
            <p className="text-lg text-gray-600">
              We provide professional residential house washing services throughout Bell Gardens. 
