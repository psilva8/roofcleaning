...
export default function GutterCleaningGardena() {
  // Service schema with city-specific information
  const serviceSchema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Gutter Cleaning in Gardena",
    "provider": {
      "@type": "LocalBusiness",
    ...
    "description": "Professional gutter cleaning and maintenance services in Gardena, Los Angeles County.",
  ...
  return (
    <>
      ...
      <Hero
        title="Gutter Cleaning in Gardena"
        subtitle="Professional gutter cleaning services for Gardena properties"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Expert Gutter Cleaning in Gardena
            </h2>
            <p className="text-lg text-gray-600">
              We provide professional gutter cleaning services throughout Gardena. 
