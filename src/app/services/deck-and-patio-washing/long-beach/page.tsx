...
export default function DeckAndPatioWashingLongBeach() {
  const serviceSchema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Deck and Patio Washing in Long Beach",
    "provider": {
      "@type": "LocalBusiness",
  ...
  return (
    <>
      ...
      <Hero
        title="Deck and Patio Washing in Long Beach"
        subtitle="Professional deck and patio washing services for Long Beach properties"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Deck and Patio Washing in Long Beach
            </h2>
            <p className="text-lg text-gray-600">
              Looking for professional deck and patio washing services in Long Beach? We specialize in serving coastal properties and marine-adjacent buildings, addressing common challenges like salt air exposure and maritime climate. Our team focuses on corrosion prevention and salt removal to deliver exceptional results.
            </p>
          </div>
