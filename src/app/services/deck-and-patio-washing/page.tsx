...
export default function DeckAndPatioWashing() {
  // Service schema for deck and patio washing
  const serviceSchema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Deck and Patio Washing Los Angeles",
    "provider": {
      "@type": "LocalBusiness",
    ...
    "description": "Professional deck and patio washing services in Los Angeles. Expert cleaning for wood, composite, and concrete outdoor living spaces.",
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Professional Deck & Patio Washing Services
            </h2>
            <p className="text-lg text-gray-600">
              We specialize in cleaning and restoring all types of outdoor living spaces. Our professional washing services remove dirt, grime, mold, and mildew while protecting your deck or patio's surface and extending its lifespan.
            </p>
          </div>
          ...
          <div className="bg-gray-50 rounded-lg p-8 mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <div>
                ...
                <p className="text-gray-600">Application of appropriate washing solutions for surface type.</p>
              </div>
              <div>
      ...
      <AreasWeServe servicePath="deck-and-patio-washing" serviceTitle="Deck & Patio Washing" />
    </>
  )
} 