        ...
        <div className="max-w-7xl mx-auto container-padding">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              ...
              <p className="paragraph">Our team brings years of experience in pressure washing services, ensuring the highest quality results for your property.</p>
            </motion.div>
            ...
            >
              ...
              <p className="paragraph">We use state-of-the-art pressure washing equipment and eco-friendly cleaning solutions for optimal results.</p>
            </motion.div>
          </div>
        </div>
      </section>
